...
The GitHub site ([https://github.com/berkeley-scf/r-bootcamp-fall-2022](https://github.com/berkeley-scf/r-bootcamp-fall-2022)) is the main site for the bootcamp. It has information on logistics, software installation, and is the master repository for materials for the modules.

 - this [Ed Discussion site (under construction)](TBD) for discussion and answering questions online during (and before) the bootcamp. 
...
If you don't want to bother using Git or have problems, simply download a zip file with all the material from [https://github.com/berkeley-scf/r-bootcamp-fall-2022/archive/main.zip](https://github.com/berkeley-scf/r-bootcamp-fall-2022/archive/main.zip).
...
* To the Statistics Department and the Statewide Database at Berkeley Law for sponsorship and logistical support.
