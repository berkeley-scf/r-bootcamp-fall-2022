...
We have an [Ed Discussion site (under construction)](TBD) for discussion and answering questions online during (and before) the bootcamp. 
...
During the afternoon break tomorrow, we'll ask everyone to fill out a feedback form, but if you leave early, please see the Ed Discussion board for the link. In order to view the recordings after the last day of the bootcamp, you'll need to fill out the feedback form!
